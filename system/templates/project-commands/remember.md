...
6. If `memory/integrations/index.md` exists, read it before logging and follow enabled integration policies.
7. Append the note under the most relevant section, such as `Work Done`, `Analysis Results`, `Learnings`, `Blockers`, or `Next`.
...
9. If the note is durable, also update `memory/learnings.md`, `memory/decisions.md`, `memory/runs.md`, or `memory/index.md` as appropriate.
10. Keep the note compact. Link to evidence paths instead of pasting bulky output.
