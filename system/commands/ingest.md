...
3. If the user did not name a date, use global changed-source mode: scan registered project paths, compare source notes with `system/sync/ingestion-ledger.yaml`, and ingest missing or changed notes into shared KB synthesis.
